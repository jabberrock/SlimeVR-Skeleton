...
public struct LogData : IFlatbufferObject
{
  ...
  public static Offset<solarxr_protocol.datatypes.LogData> CreateLogData(FlatBufferBuilder builder,
  ...
  public static Offset<solarxr_protocol.datatypes.LogData> EndLogData(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<solarxr_protocol.datatypes.LogData>(o);
  }
}
