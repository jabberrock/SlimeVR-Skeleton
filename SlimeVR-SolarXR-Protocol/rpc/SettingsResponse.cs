...
public struct SettingsResponse : IFlatbufferObject
{
  private Table __p;
  ...
  public static SettingsResponse GetRootAsSettingsResponse(ByteBuffer _bb, SettingsResponse obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  ...
  public static Offset<solarxr_protocol.rpc.SettingsResponse> CreateSettingsResponse(FlatBufferBuilder builder,
    ...
    SettingsResponse.AddYawCorrectionSettings(builder, yaw_correction_settingsOffset);
    SettingsResponse.AddResetsSettings(builder, resets_settingsOffset);
    SettingsResponse.AddAutoBoneSettings(builder, auto_bone_settingsOffset);
    SettingsResponse.AddTapDetectionSettings(builder, tap_detection_settingsOffset);
    SettingsResponse.AddModelSettings(builder, model_settingsOffset);
    SettingsResponse.AddVmcOsc(builder, vmc_oscOffset);
    SettingsResponse.AddVrcOsc(builder, vrc_oscOffset);
    SettingsResponse.AddOscRouter(builder, osc_routerOffset);
    SettingsResponse.AddDriftCompensation(builder, drift_compensationOffset);
    SettingsResponse.AddFiltering(builder, filteringOffset);
    SettingsResponse.AddSteamVrTrackers(builder, steam_vr_trackersOffset);
  ...
  public static Offset<solarxr_protocol.rpc.SettingsResponse> EndSettingsResponse(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<solarxr_protocol.rpc.SettingsResponse>(o);
  }
}
