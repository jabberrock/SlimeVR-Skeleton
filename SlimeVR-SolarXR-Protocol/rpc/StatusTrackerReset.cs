...
public struct StatusTrackerReset : IFlatbufferObject
{
  private Table __p;
  ...
  public static StatusTrackerReset GetRootAsStatusTrackerReset(ByteBuffer _bb, StatusTrackerReset obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  ...
  public static Offset<solarxr_protocol.rpc.StatusTrackerReset> CreateStatusTrackerReset(FlatBufferBuilder builder,
      Offset<solarxr_protocol.datatypes.TrackerId> tracker_idOffset = default(Offset<solarxr_protocol.datatypes.TrackerId>)) {
    builder.StartTable(1);
    StatusTrackerReset.AddTrackerId(builder, tracker_idOffset);
  ...
  public static Offset<solarxr_protocol.rpc.StatusTrackerReset> EndStatusTrackerReset(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<solarxr_protocol.rpc.StatusTrackerReset>(o);
  }
}
